...
import (
	...
	"github.com/connetos/anywatch/analyzer"
	"github.com/connetos/anywatch/api"
	"github.com/connetos/anywatch/common"
	"github.com/connetos/anywatch/config"
	"github.com/connetos/anywatch/etcd"
	"github.com/connetos/anywatch/flow"
	"github.com/connetos/anywatch/flow/enhancers"
	ondemand "github.com/connetos/anywatch/flow/ondemand/server"
	fprobes "github.com/connetos/anywatch/flow/probes"
	shttp "github.com/connetos/anywatch/http"
	"github.com/connetos/anywatch/logging"
	"github.com/connetos/anywatch/packet_injector"
	"github.com/connetos/anywatch/probe"
	"github.com/connetos/anywatch/topology/probes"
	//"github.com/connetos/anywatch/sdrop"
...
func (a *Agent) Start() {
	...
	probes.NewServer(a.WSAsyncClientPool, a.Graph)
...
func NewAgent() *Agent {
	...
	api.RegisterTopologyAPI(hserver, tr, nil)
