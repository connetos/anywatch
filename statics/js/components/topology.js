...
var TopologyComponent = {
    ...
    <div class="topology">\
      ...
      <div class="col-sm-5 fill info">\
        <tabs v-if="isAnalyzer">\
          ...
          <tab-pane title="sDrop">\
            <sdrop-table-control></sdrop-table-control>\
          </tab-pane>-->\
        </tabs>\
  ...
  methods: {
    ...
    collapseAll: function() {
      ...
      var t = setTimeout("self.layout.zoomFit()", 250);
    },
...
Graph.prototype = {
  ...
  addNode: function(id, host, metadata) {
    if (metadata.info == "This is compute node") {
      return;
    }
