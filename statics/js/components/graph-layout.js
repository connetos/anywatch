...
TopologyGraphLayout.prototype = {
  ...
  zoomIn: function() {
    this.svg.transition().duration(500).call(this.zoom.scaleBy, 1.3);
  },

  zoomOut: function() {
    this.svg.transition().duration(500).call(this.zoom.scaleBy, 0.7);
  },
  ...
  update: function() {
    ...
    */
    ...
    nodeEnter.filter(function(d) { return d.isGroupOwner(); })
      ...
      .attr("width", 16)
      .attr("height", 16)
      .attr("x", function(d) { return -self.nodeSize(d); })
      .attr("y", function(d) { return -self.nodeSize(d); })
      .attr("xlink:href", this.collapseImg);
