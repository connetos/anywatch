...
func init() {
	...
	cfg.SetDefault("logging.backends", []string{"stderr", "file"})
	cfg.SetDefault("logging.level", "DEBUG")
	cfg.SetDefault("logging.file.path", "/var/log/anywatch.log")
