...
import (
	...
	"github.com/connetos/anywatch/alert"
	...
	ondemand "github.com/connetos/anywatch/flow/ondemand/client"
	"github.com/connetos/anywatch/flow/storage"
	ftraversal "github.com/connetos/anywatch/flow/traversal"
...
func (s *Server) initialize() (err error) {
	...
	tdClient := probes.NewTopologyDetectClient(s.WSServer)

	api.RegisterTopologyAPI(s.HTTPServer, tr, tdClient)
