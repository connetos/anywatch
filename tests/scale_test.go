...
import (
	...
	gclient "github.com/connetos/anywatch/cmd/client"
	...
	"github.com/connetos/anywatch/tests/helper"
	"github.com/connetos/anywatch/topology/graph"
)

func TestHA(t *testing.T) {
	gopath := os.Getenv("GOPATH")
	scale := gopath + "/src/github.com/connetos/anywatch/scripts/scale.sh"
